...
def test_missing_data_estimate_with_enough_observations():
    supporter = MissingDataSupporter(minimum_observations=3)
...
def test_missing_data_high_confidence():
    ...
    result = supporter.estimate(
        route="DEL-BLR",
        booking_window="T+15",
        comparable_fares=[5000, 5100, 5200, 5150, 5050],
    )
...
def test_median_handles_outlier():
    ...
    result = supporter.estimate(
        route="BLR-HYD",
        booking_window="T+1",
        comparable_fares=[5000, 5100, 100000],
    )
...
def test_to_dict():
    ...
    result = supporter.estimate(
        route="MAA-DEL",
        booking_window="T+7",
        comparable_fares=[5000, 5100, 5200],
    )
